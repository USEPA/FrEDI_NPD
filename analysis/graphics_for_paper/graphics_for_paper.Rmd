...
units <- 'Billions'
  ...
  #Option B is commented out
    ggsave(plot = p, filename = 'Figure3a(2).tiff',width = 6.75,height = 1.65, bg = 'white')
    ggsave(plot = p1, filename = 'Figure3b(2).tiff',width = 7,height = 2.5,bg = 'white')
    #ggsave(plot = p2, filename = 'Figure3lgnd.tiff',width = 6.8,height = 3.5)
    ggsave(plot = p2, filename = 'Figure3c(2).tiff',width = 7,height = 4.75,bg = 'white')
